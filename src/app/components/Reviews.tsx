...
<div className="container-reviews">
    ...
    <h1>Discover the experiences of those who have wordked with us</h1>
        ...
        <div className="reviews">
            <div className="review">
                ...
                <div className="user">
                    ...
                    <div>
                        <span></span>
                        <strong>Arjun Srivastav & Tapasya Srivastav</strong>
                        <p>Couple from New Delhi</p>
                    </div>
                </div>
            </div>
             <div className="review">
                ...
                <div className="user">
                    ...
                    <div>
                        <strong>Ram Chaturvedi</strong>
                        <p>Guest from Lucknow</p>
                    </div>
                </div>
            </div>
            <div className="review">
